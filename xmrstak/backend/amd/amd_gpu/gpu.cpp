...
size_t XMRSetJob(GpuContext* ctx, uint8_t* input, size_t input_len, uint64_t target, xmrstak_algo_id miner_algo)
{
...
size_t XMRRunJob(GpuContext* ctx, cl_uint* HashOutput, xmrstak_algo_id miner_algo)
{
	const auto & Kernels = ctx->Kernels[miner_algo];
