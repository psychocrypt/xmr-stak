...
public:
	...
	typedef void (*cn_hash_fun)(const void*, size_t, void*, cryptonight_ctx**, xmrstak_algo);

	static cn_hash_fun func_selector(bool bHaveAes, bool bNoPrefetch, xmrstak_algo_id algo);
...
private:
	...
	template<size_t N>
	static cn_hash_fun func_multi_selector(bool bHaveAes, bool bNoPrefetch, xmrstak_algo_id algo, const std::string& asm_version_str = "off");
