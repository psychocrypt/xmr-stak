...
void cn_explode_scratchpad(const __m128i* input, __m128i* output, xmrstak_algo algo)
{
...
void cn_explode_scratchpad_gpu(const uint8_t* input, uint8_t* output, xmrstak_algo algo)
{
...
template<bool SOFT_AES, bool PREFETCH, xmrstak_algo_id ALGO>
void cn_implode_scratchpad(const __m128i* input, __m128i* output, xmrstak_algo algo)
{
...
struct Cryptonight_hash<1>
{
	...
	static void hash(const void* input, size_t len, void* output, cryptonight_ctx** ctx, xmrstak_algo algo)
	{
